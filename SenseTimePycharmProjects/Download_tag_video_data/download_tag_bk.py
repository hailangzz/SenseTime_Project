...
tag2data = {
    '2023-12-11': 's3://sdc_gac/广州建图采集/2d量产版本采集/2023_12/segment_data/GOP/A02-459/20231211/',
    '2023-12-12': 's3://sdc_gac/广州建图采集/2d量产版本采集/2023_12/segment_data/GOP/A02-459/20231212/',
    '2023-12-14': 's3://sdc_gac/广州建图采集/2d量产版本采集/2023_12/segment_data/GOP/A02-459/20231214/',
    '2023-12-15': 's3://sdc_gac/广州建图采集/2d量产版本采集/2023_12/segment_data/GOP/A02-459/20231215/',
    '2023-12-16': 's3://sdc_gac/广州建图采集/2d量产版本采集/2023_12/segment_data/GOP/A02-459/20231216/',
    '2023-12-17': 's3://sdc_gac/广州建图采集/2d量产版本采集/2023_12/segment_data/GOP/A02-459/20231217/',
    '2023-12-18': 's3://sdc_gac/广州建图采集/2d量产版本采集/2023_12/segment_data/GOP/A02-459/20231218/',
    '2023-12-19': 's3://sdc_gac/广州建图采集/2d量产版本采集/2023_12/segment_data/GOP/A02-459/20231219/',
        ...
        for idx, line in enumerate(lines):
            ...
            try:
                ...
                for director_name in director_out_name_list:
                    ...
                    print('timestamp_add_eight_hours:',timestamp_add_eight_hours)
